;;; chatgpt-shell.el --- A multi-llm Emacs shell (ChatGPT, Claude, Gemini, Ollama, Perplexity) + editing integrations  -*- lexical-binding: t -*-
...
(defconst chatgpt-shell--version "2.5.1")
