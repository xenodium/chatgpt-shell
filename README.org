...
|         | chatgpt-shell-previous-input                        | Cycle backwards through input history, saving input.              |
...
|         | chatgpt-shell-search-history                        | Search comint input ring.                                         |
|         | chatgpt-shell-send-and-review-region                | Send region to ChatGPT, review before submitting.                 |
|         | chatgpt-shell-next-input                            | Cycle forwards through input history.                             |
...
|         | chatgpt-shell-return                                | RET binding.                                                      |
