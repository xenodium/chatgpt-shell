...
| M-r, <menu-bar> <inout> <history-isearch-backward-regexp> | chatgpt-shell-search-history                        | Search previous input history.                                    |
...
| dall-e-shell-submit                  | Submit current input.                                |
...
| dall-e-shell-search-history          | Search previous input history.                       |
