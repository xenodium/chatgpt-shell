...
You will need to get an API key for each of the various public LLM endpoints you
...
=M-x set-variable chatgpt-shell-kagi-key=
...
#+begin_src emacs-lisp
  ...
  (setq chatgpt-shell-deepseek-key "my deepseek key")
  (setq chatgpt-shell-openai-key "my openai key")
   ...
#+end_src

** Set the appropriate variable programatically, in your emacs init file, from the environment
#+begin_src emacs-lisp
