       ...
       (when (and (string-match "^chatgpt-shell"
         ...
         (push `(,(mapconcat
                   ...
                   (or
                    ...
                    (where-is-internal
                     (symbol-function symbol)
                     chatgpt-shell-mode-map nil nil (command-remapping symbol)))", ")
                 ,symbol
                 ,(car
                   (split-string
...
| C-<up>, M-p, <menu-bar> <inout> <previous-history>        | chatgpt-shell-previous-input                        | Cycle backwards through input history, saving input.              |
...
| M-r, <menu-bar> <inout> <history-isearch-backward-regexp> | chatgpt-shell-search-history                        | Search comint input ring.                                         |
|                                                           | chatgpt-shell-send-and-review-region                | Send region to ChatGPT, review before submitting.                 |
| C-<down>, M-n, <menu-bar> <inout> <next-history>          | chatgpt-shell-next-input                            | Cycle forwards through input history.                             |
...
| RET                                                       | chatgpt-shell-return                                | RET binding.                                                      |
...
| Command                              | Description                                          |
|--------------------------------------+------------------------------------------------------|
| dall-e-shell-previous-input          | Cycle backwards through input history, saving input. |
| dall-e-shell                         | Start a DALL-E shell.                                |
| dall-e-shell-return                  | RET binding.                                         |
| dall-e-shell-save-session-transcript | Save shell transcript to file.                       |
| dall-e-shell-mode                    | Major mode for DALL-E shell.                         |
| dall-e-shell-next-input              | Cycle forwards through input history.                |
| dall-e-shell-search-history          | Search comint input ring.                            |
