...
| mk-shell-display-function             | Function to display new shell. Can be set to `display-buffer' or similar. |
| mk-shell-on-response-function         | Function to automatically execute after last command output.              |
| mk-shell-read-string-function         | Function to read strings from user.                                       |
...
| mk-shell-save-session-transcript                   | Save shell transcript to file.                         |
