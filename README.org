...
=chatgpt-shell= is young package still. Please report issues or send [[https://github.com/xenodium/chatgpt-shell/pulls][pull requests]] for improvements.

I hope =chatgpt-shell= is becoming as useful to you as it is for me.

✨[[https://github.com/sponsors/xenodium][Sponsorships]]✨ are also greatly appreciated.
